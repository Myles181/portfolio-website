      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              {[
                { href: "https://github.com/Myles181", icon: <Github size={24} /> },
                { href: "https://linkedin.com/in/cyrilmyles1", icon: <Linkedin size={24} /> },
                { href: "mailto:cyril450@gmail.com", icon: <Mail size={24} /> }
              ].map((social, index) => (
                <motion.a
                  key={social.href}
